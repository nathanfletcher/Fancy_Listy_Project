...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //Declaring and initializing fragment classes
        FragmentManager fragmentManager = getFragmentManager();
        android.app.FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        FirstFragment frag1 = new FirstFragment();
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentTransaction.replace(R.id.fragment_container, frag2, "Our Second Fragment");
        } else if (id == R.id.nav_slideshow) {
            fragmentTransaction.replace(R.id.fragment_container, frag3, "Our Third Fragment");
